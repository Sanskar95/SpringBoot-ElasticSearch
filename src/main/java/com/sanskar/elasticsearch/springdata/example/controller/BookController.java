package com.sanskar.elasticsearch.springdata.example.controller;

import com.sanskar.elasticsearch.springdata.example.metadata.PublicationYear;
...
public class BookController {
    ...
    public void bulkUpload(@Valid @RequestBody List<BookDto> booksDto) throws DuplicateIsbnException {
        List<Book> bookList= booksDto.stream().map(BookDto::transform).collect(Collectors.toList());
        bookService.createMany(bookList);
    }
